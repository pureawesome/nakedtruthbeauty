...
<a class="group" target="_blank" data-instagram-rel="1" href="<?php print $href ?>" rel="noopener">
  <img class="lazy-img fa-spin fa-spinner fa-2x" alt="<?php print $post->caption->text; ?>" style="float: left; margin: 0 5px 5px 0px; width: <?php print $width ?>px; height: <?php print $height ?>px;" data-src="<?php print $src ?>">
</a>
